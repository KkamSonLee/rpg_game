...
const int Monster::Monsterlist[3][9] = {{100, 20, 100, 20, 100, 50, 1, 2, 100},
                                        {100, 20, 100, 20, 100, 50, 1, 2, 100},
                                        {100, 20, 100, 20, 100, 50, 1, 2, 100}};
//우선은 같은 형식을 
const string Monster::namelist[3] = {"pig", "slime", "bee"};

Monster::Monster(int i_MonsterNum) // 번호만 주도록 변경
{
    monsterStatus.set_status(Monsterlist[i_MonsterNum - 1][0], Monsterlist[i_MonsterNum - 1][1],
                             Monsterlist[i_MonsterNum - 1][2], Monsterlist[i_MonsterNum - 1][3],
                             Monsterlist[i_MonsterNum - 1][4], Monsterlist[i_MonsterNum - 1][5],
                             Monsterlist[i_MonsterNum - 1][6], Monsterlist[i_MonsterNum - 1][7],
                             Monsterlist[i_MonsterNum - 1][8]);
...
void Monster::setStat(int num) {}

void Monster::attack(Character &i_ch, int i_mp) {

    int damage = i_ch.get_nhp() - (monsterStatus.get_atk());// ������ ĳ������ ���� hp - ������ ���ݷ�
...
string Monster::get_name(
        int num) {// ���� ��ȣ�� �Է��ϸ� �ش� ������ �̸��� ��ȯ�մϴ�. �ٸ� status������ ���� �̸� ������ �ټ� ���� ������ �ڵ� ���ο��� �����迭�� ���ؼ�
    // ���ϴ� ����� ����߽��ϴ�. 
